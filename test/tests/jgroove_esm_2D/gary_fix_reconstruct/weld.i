...
[Problem]
  ...
  restart_file_base = out/preheat_cp/LATEST
[]
...
[Materials]
  ...
  [volumetric_heat]
    ...
    ry = 2.075
    rz = 2.075
    power = 150 # W/mm # average values from other paper
    # 2 pi R = 345.6 mm
    # 4193.7/345.6 = 12.13 W/mm
    # 1900/417 = 4.55
    # 12.13 *4.55 =55.2
  ...
  [birth_strain]
    type = ADBirthSmallStrain
    birth_strain = 'reconst_birth_strain'
  []
  [reconst_strain]
    type = ADComputeSmallStrain
    eigenstrain_names = 'birth_strain'
    base_name = 'reconst'
  []
  [reconst_eigenstrain]
    type = ADEigenstrainFromLinearElasticStress
    elasticity_tensor = 'elasticity_tensor'
    stress = 'stress'
    strain = 'reconst_mechanical_strain'
    eigen_strain = 'reconst_eigenstrain'
    outputs = 'exodus'
  []
[]
...
[BCs]
  ...
  [convective_surface] # Convective Start
    ...
    heat_transfer_coefficient = 0.00001 # I copied it from Bipul # h = convective heat transfer coefficient (w/mm^2-K) # Convective End
  []
